		...
		(categories) => {
			res.render("categories/index", {
				data: categories.reduce((acc, category) => {
					// Aqui eu estou usando o reduce para transformar o array de objetos em um array de objetos com apenas os atributos que eu quero
					acc.push({
						id: category.id,
...
router.get("/read/:slug", (req, res) => {
	...
	//TODO: Isso aqui vai ficar em services/article-using-category

	let category = Category.findOne({
		where: { slug },
		include: [{ model: Article }],
	}); // Eu estou incluindo todos os artigos que tiverem essa categoria
...
router.post("/delete", authenticate, (req, res) => {
	let id = req.body.id;
	// TODO: Colocar em services/article-using-category
